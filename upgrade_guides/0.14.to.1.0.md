...
In Guardian 0.14 it was allowed to have a null token in the authorization header, this is no longer allowed, see [this](https://github.com/ueberauth/guardian/issues/573) issue for more information
